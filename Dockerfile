...
RUN mkdir -p /root/.android && touch /root/.android/repositories.cfg && \
    ...
    yes | $ANDROID_HOME/tools/bin/sdkmanager "platforms;android-20" "platforms;android-21" "platforms;android-22" "platforms;android-23" "platforms;android-24" "platforms;android-25"  && \
    yes | $ANDROID_HOME/tools/bin/sdkmanager "platforms;android-26" "platforms;android-27" "platforms;android-28" "platforms;android-29"
